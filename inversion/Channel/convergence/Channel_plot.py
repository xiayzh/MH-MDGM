...
class Plot_convergence(object):
    ...
    def plot_para_rss(self,para_rss_64,para_rss_16_64,para_rss_16_32_64):
        ...
        plt.legend()
        plt.savefig(os.getcwd()+ f'/Channel/convergence/images/channel_para_rss_convergence.pdf',bbox_inches = 'tight', dpi=1000,pad_inches=0.0)
        plt.close()
    ...
    def plot_obs_rss(self,rss64,rss16_64,rss16_32_64):
        ...
        plt.legend()
        plt.savefig(os.getcwd()+ f'/Channel/convergence/images/channel_obs_rss_convergence.pdf',bbox_inches = 'tight', dpi=1000,pad_inches=0.0)
        plt.close()
