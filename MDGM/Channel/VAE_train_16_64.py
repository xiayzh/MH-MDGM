...
for epoch in range(1,args.n_epochs+1):
    ...
    if (epoch) % args.sample_interval == 0:
        ...
        torch.save(decoder.state_dict(), model_dir + f'/decoder_16_64_VAE_1_{args.beta_vae}_epoch{epoch}.pth')
        torch.save(encoder.state_dict(), model_dir + f'/encoder_16_64_VAE_1_{args.beta_vae}_epoch{epoch}.pth')
